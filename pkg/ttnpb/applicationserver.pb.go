...
func (*ApplicationLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_26eb092656ca3ef7, []int{0}
}
...
func (*GetApplicationLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_26eb092656ca3ef7, []int{1}
}
...
func (*SetApplicationLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_26eb092656ca3ef7, []int{2}
}
...
func (*ApplicationLinkStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_26eb092656ca3ef7, []int{3}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/applicationserver.proto", fileDescriptor_applicationserver_26eb092656ca3ef7)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/applicationserver.proto", fileDescriptor_applicationserver_26eb092656ca3ef7)
}

var fileDescriptor_applicationserver_26eb092656ca3ef7 = []byte{
	...
	,
}
